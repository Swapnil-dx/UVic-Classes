...
; **** BEGINNING OF "STUDENT CODE" SECTION **** 
	...
	ldi R18, 0  ;initializing R18 register
	
	loop1:
		ldi R17, 0b00000001		;mask to get LSB
		and R17, R16	;get LSB
		Add R18, R17	;count number of 1
		lsr R16		;bit shift right to read next bit
		dec R20
		brne loop1
	
	andi R18, 0b00000001	;Only need LSB to decide
	sts PARITY, R18			;whether even or odd number of 1s
