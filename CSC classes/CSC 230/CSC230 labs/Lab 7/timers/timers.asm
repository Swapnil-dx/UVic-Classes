...
.equ TOP3=int(0.5+(CLOCK/PRESCALE_DIV*DELAY3))	;Determine top value for desired delay
.if TOP3>65535
...
.endif
	...
	sts OCR3AH, temphigh	;set upper limit to get correct delay
	sts OCR3AL, templow
...
main_loop: ;apply delay 3 to LED3
	check_timer_3:
		in temp, TIFR3
		sbrs temp, OCF3A
		rjmp set_leds
	...
	check_timer_4: ;apply delay 4 to LED4
	...
	check_timer_5:	;apply delay 5 to LED5
