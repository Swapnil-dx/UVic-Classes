...
no_pulse:
		ldi r16, 1			;go to row 1 column 11 on lcd screen
		ldi r17, 11
		push r16
		push r17
		rcall lcd_gotoxy
		...
		rcall to_decimal_text		;Use provided code to convert BUTTON_COUNT to decimal text
		pop temp
		pop temp
		pop temp
		pop temp
...
timer4:
	...
	lds temp, BUTTON_CURRENT		;store current value of the button to BUTTON_PREVIOUS
	sts BUTTON_PREVIOUS, temp
