...
.equ DDRL = 0x10A
		...
		ldi r17, 0xFF		; set data direction, that is the LED as output
		sts DDRB, r17
		sts DDRL, r17

lp:
		ldi r19, 0b00000010 ; turn on the light on the bottom
		sts PORTB, r19
		ldi r19, 0x80  ; 0x80=0b10000000 turn on the light at the top
		sts PORTL, r19

		; now the lights are on, let them on for a while
		ldi r20, 0x40

		; TODO: call the subroutine delay here:
del1:	nop
		ldi r21,0xFF
del2:	nop
		ldi r22, 0xFF
del3:	nop
		...
		; now the lights are off, let them off for a while
		; TODO: call the subroutine delay here:
del1_2:	nop
		ldi r21,0xFF
del2_2:	nop
...
; TODO write delay subroutine here: